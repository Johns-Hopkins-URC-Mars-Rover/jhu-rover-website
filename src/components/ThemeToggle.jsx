...
export default function ThemeToggle() {
  ...
  useEffect(() => {
    ...
    setChecked(savedTheme === LIGHT_THEME);
  }, []);
  ...
  function toggleTheme() {
    ...
    curtain.className =
      'fixed top-0 right-0 h-full bg-base-300 z-50 animate-curtain-in transition-colors duration-400';
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        curtain.classList.remove('animate-curtain-in');
        curtain.classList.add('animate-curtain-out');
